defmodule LiveElement.Controller do
  @moduledoc """
  ...
  See `LiveElement.Helpers.live_render/3` for all supported options.
  ...
  ## Examples
      ...
      defmodule ThermostatController do
        ...
        # "use MyAppWeb, :controller" should import LiveElement.Controller.
