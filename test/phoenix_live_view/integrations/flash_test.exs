defmodule LiveElement.FlashIntegrationTest do
  use ExUnit.Case, async: true
  import Phoenix.ConnTest

  import LiveElementTest
  alias LiveElement
  alias LiveElementTest.{Endpoint, Router}
  ...
  describe "LiveView <=> LiveView" do
    ...
    test "raises on invalid assert redirect", %{conn: conn} do
      ...
      assert_raise ArgumentError,
                   "expected LiveElementTest.FlashChildLive to redirect to \"/wrong\", but got a redirect to \"/flash-root\"",
      ...
      assert_raise ArgumentError,
                   "expected LiveElementTest.FlashLive to redirect to \"/wrong\", but got a patch to \"/flash-root?foo\"",
    ...
    test "raises on invalid assert patch", %{conn: conn} do
      ...
      assert_raise ArgumentError,
                   "expected LiveElementTest.FlashLive to patch to \"/wrong\", but got a patch to \"/flash-root?foo\"",
      ...
      assert_raise ArgumentError,
                   "expected LiveElementTest.FlashChildLive to patch to \"/wrong\", but got a redirect to \"/flash-root\"",
